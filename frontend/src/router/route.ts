...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		path: '/',
		name: '/',
		component: () => import('/frontend/src/layout/index.vue'),
		redirect: '/home',
		meta: {
			isKeepAlive: true,
		},
		children: [
			{
				path: '/home',
				name: 'home',
				component: () => import('/frontend/src/views/home/index.vue'),
				meta: {
			...
			},
			{
				path: '/personal',
				name: 'personals',
				component: () => import('/frontend/src/views/system/personal/index.vue'),
				meta: {
					title: '个人中心',
					isLink: '',
					isHide: true,
...
export const demoRoutes:Array<RouteRecordRaw> = [
	{
		path: '/demo',
		name: 'demo',
		component: () => import('/frontend/src/layout/routerView/parent.vue'),
		...
		children:[
				...
				children: [
					{
						...
						name: 'systemMenu',
						component: () => import('/frontend/src/views/system/menu/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'systemRole',
						component: () => import('/frontend/src/views/system/role/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'systemUser',
						component: () => import('/frontend/src/views/system/user/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'systemDept',
						component: () => import('/frontend/src/views/system/dept/index.vue'),
						meta: {
			...
			},
			{
				...
				children: [
						...
						children: [
							{
								...
								name: 'menu11',
								component: () => import('/frontend/src/views/menu/menu1/menu11/index.vue'),
								meta: {
								...
								children: [
									{
										...
										name: 'menu121',
										component: () => import('/frontend/src/views/menu/menu1/menu12/menu121/index.vue'),
										meta: {
									...
									},
									{
										...
										name: 'menu122',
										component: () => import('/frontend/src/views/menu/menu1/menu12/menu122/index.vue'),
										meta: {
							...
							},
							{
								...
								name: 'menu13',
								component: () => import('/frontend/src/views/menu/menu1/menu13/index.vue'),
								meta: {
					...
					},
					{
						...
						name: 'menu2',
						component: () => import('/frontend/src/views/menu/menu2/index.vue'),
						meta: {
				...
				children: [
					{
						...
						name: 'funTagsView',
						component: () => import('/frontend/src/views/fun/tagsView/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funCountup',
						component: () => import('/frontend/src/views/fun/countup/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'demoCodeMirror',
						component: () => import('/frontend/src/views/fun/codemirror/index.vue'),
						meta: {
							title: '代码编辑器',
							isLink: '',
							isHide: false,
					...
					},
					{
						...
						name: 'funCropper',
						component: () => import('/frontend/src/views/fun/cropper/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funQrcode',
						component: () => import('/frontend/src/views/fun/qrcode/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funEchartsMap',
						component: () => import('/frontend/src/views/fun/echartsMap/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funPrintJs',
						component: () => import('/frontend/src/views/fun/printJs/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funClipboard',
						component: () => import('/frontend/src/views/fun/clipboard/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funGridLayout',
						component: () => import('/frontend/src/views/fun/gridLayout/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'funSplitpanes',
						component: () => import('/frontend/src/views/fun/splitpanes/index.vue'),
						meta: {
				...
				children: [
					{
						...
						name: 'pagesFiltering',
						component: () => import('/frontend/src/views/pages/filtering/index.vue'),
						meta: {
						...
						children: [
							{
								...
								component: () => import('/frontend/src/views/pages/filtering/details.vue'),
								meta: {
					...
					},
					{
						...
						component: () => import('/frontend/src/views/pages/filtering/details1.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesIocnfont',
						component: () => import('/frontend/src/views/pages/iocnfont/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesElement',
						component: () => import('/frontend/src/views/pages/element/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesAwesome',
						component: () => import('/frontend/src/views/pages/awesome/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesFormAdapt',
						component: () => import('/frontend/src/views/pages/formAdapt/index.vue'),
						meta: {
					...
					},
					{
						...
						component: () => import('/frontend/src/views/pages/tableRules/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesFormI18n',
						component: () => import('/frontend/src/views/pages/formI18n/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesFormRules',
						component: () => import('/frontend/src/views/pages/formRules/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesListAdapt',
						component: () => import('/frontend/src/views/pages/listAdapt/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesWaterfall',
						component: () => import('/frontend/src/views/pages/waterfall/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesSteps',
						component: () => import('/frontend/src/views/pages/steps/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesPreview',
						component: () => import('/frontend/src/views/pages/preview/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesWaves',
						component: () => import('/frontend/src/views/pages/waves/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesTree',
						component: () => import('/frontend/src/views/pages/tree/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesDrag',
						component: () => import('/frontend/src/views/pages/drag/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesLazyImg',
						component: () => import('/frontend/src/views/pages/lazyImg/index.vue'),
						meta: {
					...
					},
					{
						...
						component: () => import('/frontend/src/views/pages/dynamicForm/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesWorkflow',
						component: () => import('/frontend/src/views/pages/workflow/index.vue'),
						meta: {
				...
				children: [
					{
						...
						name: 'makeSelector',
						component: () => import('/frontend/src/views/make/selector/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'makeNoticeBar',
						component: () => import('/frontend/src/views/make/noticeBar/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'makeSvgDemo',
						component: () => import('/frontend/src/views/make/svgDemo/index.vue'),
						meta: {
				...
				children: [
					{
						...
						name: 'paramsCommon',
						component: () => import('/frontend/src/views/params/common/index.vue'),
						meta: {
					...
					},
					{
						...
						component: () => import('/frontend/src/views/params/common/details.vue'),
						meta: {
					...
					},
					{
						...
						name: 'paramsDynamic',
						component: () => import('/frontend/src/views/params/dynamic/index.vue'),
						meta: {
					 ...
					 */
					{
						...
						component: () => import('/frontend/src/views/params/dynamic/details.vue'),
						meta: {
				...
				children: [
					{
						...
						component: () => import('/frontend/src/layout/routerView/link.vue'),
						meta: {
			...
			},
			{
				path: '/demo/chart',
				name: 'chartIndex',
				component: () => import('/frontend/src/views/chart/index.vue'),
				meta: {
			...
			},
			{
				path: '/demo/personal',
				name: 'personal',
				component: () => import('/frontend/src/views/personal/index.vue'),
				meta: {
			...
			},
			{
				path: '/demo/tools',
				name: 'tools',
				component: () => import('/frontend/src/views/tools/index.vue'),
				meta: {
			...
			},
			{
				...
				component: () => import('/frontend/src/layout/routerView/iframes.vue'),
				meta: {
...
export const notFoundAndNoPower = [
	{
		path: '/:path(.*)*',
		name: 'notFound',
		component: () => import('/frontend/src/views/error/404.vue'),
		meta: {
	...
	},
	{
		path: '/401',
		name: 'noPower',
		component: () => import('/frontend/src/views/error/401.vue'),
		meta: {
...
export const staticRoutes: Array<RouteRecordRaw> = [
	{
		path: '/login',
		name: 'login',
		component: () => import('/frontend/src/views/login/index.vue'),
		meta: {
			title: '登录',
		},
	},
	 ...
	 */
	{
		...
		component: () => import('/frontend/src/views/visualizing/demo1.vue'),
		meta: {
			title: 'message.router.visualizingLinkDemo1',
		},
	},
	{
		...
		component: () => import('/frontend/src/views/visualizing/demo2.vue'),
		meta: {
			title: 'message.router.visualizingLinkDemo2',
		},
	},
